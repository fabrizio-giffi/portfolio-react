  ...
  return (
    ...
    >
      ...
      <Typography mb={3} color="var(--text-primary)" variant="h5" textAlign={"center"}>
        As a web developer I strive to find the sweet spot between an aesthetically pleasing interface and a seamlessly operating
      ...
      <Typography className="text-cta" textAlign="center" color="var(--text-primary)" variant="h6" mt={3}>
